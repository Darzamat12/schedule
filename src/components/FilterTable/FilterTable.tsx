...
const FilterTable: React.FC = ({ userPreferences }: any) => {
  const columns: ColumnsType<Event> = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Space size="middle">
          <Button className={userPreferences.readable ? 'readable-bold-1' : ''}>Edit</Button>
          <Button className={userPreferences.readable ? 'readable-bold-1' : ''}>Delete</Button>
        </Space>
      ),
    },
    {
